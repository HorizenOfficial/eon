...
public class EonForkConfigurator extends ForkConfigurator {
    ...
    static final int F2_GOBI_TESTNET_FORKPOINT = 1744; ///estimated start: Tue 3 Oct 2023 16:21 Milano time
    static final int F2_TESTNET_FORKPOINT = 800;
    static final int F2_MAINNET_FORKPOINT = 1039;  ///estimated start: Thu 12 Oct 2023 15:55 Milano time
