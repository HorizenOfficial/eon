...
EVM_STATE_DUMP_ENABLED="${EVM_STATE_DUMP_ENABLED:-false}"
export EVM_STATE_DUMP_ENABLED
...
'$SCNODE_REST_APIKEYHASH:$SCNODE_REST_PORT:$ONLY_CONNECT_TO_KNOWN_PEERS:$FORGER_MAXCONNECTIONS:$FORGER_REWARD_ADDRESS:$SCNODE_METRICS_ENABLED:$SCNODE_METRICS_PORT:$SCNODE_METRICS_APIKEYHASH:$EVM_STATE_DUMP_ENABLED'\
